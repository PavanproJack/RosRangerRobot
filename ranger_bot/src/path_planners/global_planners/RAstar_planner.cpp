...
#include "RAstar_planner.h"

#include "tf/transform_datatypes.h"

// #include "path_planners/global_planner/global_planner.h"

 //register this planner as a BaseGlobalPlanner plugin
 PLUGINLIB_EXPORT_CLASS(RAstar_planner::GlobalPlanner, nav_core::BaseGlobalPlanner)
...
void GlobalPlanner::getCorrdinate(float& x, float& y)
{
...
void GlobalPlanner::convertToCoordinate(int index, float& x, float& y)
{
...
vector<int> GlobalPlanner::RAstarPlanner(int startCell, int goalCell){
...
vector<int> GlobalPlanner::findPath(int startCell, int goalCell, float g_score[])
{
	value++;
	vector<int> bestPath;
...
vector<int> GlobalPlanner::constructPath(int startCell, int goalCell,float g_score[])
{
	vector<int> bestPath;
	vector<int> path;
...
void GlobalPlanner::addNeighborCellToOpenList(multiset<cells> & OPL, int neighborCell, int goalCell, float g_score[])
{
	cells CP;
...
vector <int> GlobalPlanner::findFreeNeighborCell (int CellID){
...
float  GlobalPlanner::getMoveCost(int CellID1, int CellID2){
 ...
 return OGM[CellID];
  ...
  //verify if the cell(i,j) is free
 bool  GlobalPlanner::isFree(int CellID){
 return OGM[CellID];
 } 
